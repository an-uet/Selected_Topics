...
class FFTLoss(nn.Module):
    """Frequency loss on amplitude spectrum via 2D FFT.

    Penalises errors in the amplitude spectrum of the SR image vs HR.
    Complements pixel loss: pixel loss is good for smooth regions,
    FFT loss is good for edges/textures/high-frequency content.

    Args:
        loss_weight (float): Weight for this loss. Default: 0.05.
