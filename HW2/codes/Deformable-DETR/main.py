...
def get_args_parser():
    ...
    parser.add_argument('--pretrain_backbone', default='', type=str,
                    help='path to checkpoint to load backbone only')
...
def main(args):
    ...
    if args.pretrain_backbone:
        print(f"Loading backbone from {args.pretrain_backbone}")
        checkpoint = torch.load(args.pretrain_backbone, map_location='cpu')
