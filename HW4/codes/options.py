...
# Data Parameters
parser.add_argument('--data_file_dir', type=str, default='/mnt/HDD4/anlt/data/hw4_realse_dataset/',  help='where clean images of denoising saves.')
parser.add_argument('--derain_dir', type=str, default='/mnt/HDD4/anlt/data/hw4_realse_dataset/',
                    help='where training images of deraining saves.')
parser.add_argument('--desnow_dir', type=str, default='/mnt/HDD4/anlt/data/hw4_realse_dataset/',
...
parser.add_argument(
    "--resume_ckpt",
    type=str,
    default='train_ckpt_aug20/last.ckpt',
)
