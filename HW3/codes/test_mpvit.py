...
def get_parser():
    ...
    parser.add_argument("--test_folder", type=str, default="/mnt/HDD4/anlt/data/hw3-data/test_release")
    ...
    parser.add_argument("--mapping_json", type=str, default="/mnt/HDD4/anlt/data/hw3-data/test_image_name_to_ids.json")
