...
register_coco_instances(
    "train_data", {}, "/mnt/HDD4/anlt/data/hw3-data/full.json", "/mnt/HDD4/anlt/data/hw3-data/train"
)
# register_coco_instances(
#     "my_dataset_val", {}, "/mnt/HDD4/anlt/data/hw3-data/val.json", "/mnt/HDD4/anlt/data/hw3-data/train"
# )
MetadataCatalog.get("train_data")
DatasetCatalog.get("train_data")
...
if __name__ == "__main__":
    ...
    if args.debug:
        ...
        debugpy.listen(address=('0.0.0.0', 9312))
